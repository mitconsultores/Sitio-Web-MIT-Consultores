      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          ...
          <div className="bg-[#F6EDE3] rounded-2xl p-8">
            <h3 className="text-2xl font-bold text-[#171b0b] mb-4">¿Por qué elegirnos?</h3>
            ...
            <a 
              href="/contacto" 
              className="inline-block bg-[#171b0b] text-white px-6 py-3 rounded-lg font-medium hover:bg-[#998B6D] transition-colors"
            >
              Solicitar Consulta
            </a>
          </div>
