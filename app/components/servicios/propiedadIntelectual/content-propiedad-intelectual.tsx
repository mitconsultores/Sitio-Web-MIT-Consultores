export function ContentPropiedadIntelectual() {
  return (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          ...
          <div className="bg-[#F6EDE3] rounded-2xl p-8">
            ...
            <p className="text-[#666472] mb-6 leading-relaxed">
              En un mundo cada vez más digitalizado, proteger su propiedad intelectual es fundamental. Nuestro equipo cuenta con experiencia especializada en el registro, defensa y monetización de activos intangibles, asegurando que sus innovaciones y creaciones estén debidamente protegidas.
            </p>
            <a 
              href="/contacto" 
